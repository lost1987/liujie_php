...
class MailDailyService extends ServerDBChooser{
    ...
    public function num_rows($condition){
        ...
        $sql = "select count(a.id1) as num  from $this->table_record a left join $this->table_user b on  a.id1=b.id LEFT JOIN MMO2D_StaticLJZM.dbo.fr_item d on a.param1=d.id $consql";
    ...
    public function getCondition($condition){
        ...
        if(empty($sql))
            ...
            return " where a.param4 in ($this->arr_str) and a.id <> 1293035";
        return $sql = " where a.param4 in ($this->arr_str) and  a.id <> 1293035 and ".$sql;
...
as time,b.id,b.account_name,b.name,b.levels,d.name as mailcontent from  $this->table_record a left join   $this->table_user b on a.id1=b.id  LEFT JOIN MMO2D_StaticLJZM.dbo.fr_item d on a.param1=d.id $consql)
