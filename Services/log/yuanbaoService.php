        ...
        public function lists($page,$condition){
            ...
            if(!empty($server)){
                    ...
                    $sql = "select * from (select row_number() over (order by a.time desc) as rownumber,
                     a.id1,a.type,a.str as action,a.param2,a.param4,CONVERT(varchar(20),  a.time, 120) as time,b.id,b.account_name,b.name,b.levels,b.yuanbao from $this->table_record a left join $this->table_user b on a.id1=b.id $consql )
