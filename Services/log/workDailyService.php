...
as time,b.id,b.account_name,b.name,b.levels,d.name as workname from  $this->table_record a left join   $this->table_user b on a.id1=b.id LEFT JOIN MMO2D_StaticLJZM.dbo.fr_item d on a.param1=d.id $consql)
